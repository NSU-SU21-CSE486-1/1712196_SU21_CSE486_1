...
public class ProfileMainActivity extends AppCompatActivity {
    ...
    private void Info() {
        ...
        if (TextUtils.isEmpty(FullName)){
            Toast.makeText(ProfileMainActivity.this, "please enter your Name", Toast.LENGTH_SHORT).show();
            return;
        }
        else if (TextUtils.isEmpty(DateOfBirth)){
            Toast.makeText(ProfileMainActivity.this, "please enter DateOfBirth", Toast.LENGTH_SHORT).show();
            return;
        }
        else if (TextUtils.isEmpty(NID)){
            Toast.makeText(ProfileMainActivity.this, "please enter NID", Toast.LENGTH_SHORT).show();
            return;
        }
        else if (NID.length()<13){
            Toast.makeText(ProfileMainActivity.this, "Nid number minimum 13 and max 18 numbers", Toast.LENGTH_SHORT).show();
            return;
        }
        else if (TextUtils.isEmpty(BloodGroup)){
            Toast.makeText(ProfileMainActivity.this, "please enter bloodGroup", Toast.LENGTH_SHORT).show();
            return;
        }

        Intent intent = new Intent(ProfileMainActivity.this, UniversityAffiliationActivity.class);
