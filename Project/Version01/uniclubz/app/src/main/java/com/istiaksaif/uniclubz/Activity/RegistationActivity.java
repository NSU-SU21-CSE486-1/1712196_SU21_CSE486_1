...
public class RegistationActivity extends AppCompatActivity {
    ...
    private void Register() {
        ...
        if (TextUtils.isEmpty(FullName)){
            ...
            Toast.makeText(RegistationActivity.this, "password week & password length at least 8 character", Toast.LENGTH_SHORT).show();
            return;
        }
            ...
            @Override
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            User userhelp = new User(FullName,Email,null,"","","","","",NID,uid,"offline");
                            ...
                            Intent intent = new Intent(RegistationActivity.this, UserHomeActivity.class);
                            startActivity(intent);
                        } else {
